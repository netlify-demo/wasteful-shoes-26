...
admin](https://app.netlify.com/sites/wasteful-shoes-26/overview) for this
...
at a [new URL](https://v2--wasteful-shoes-26.netlify.com):

    https://v2--wasteful-shoes-26.netlify.com
